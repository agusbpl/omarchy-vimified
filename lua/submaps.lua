...
function M.setup_standard_submaps()
  ...
  hl.define_submap("System", function()
    ...
    submap_cmd("g", "Wallpaper Menu", "omarchy-menu toggle background")
    submap_cmd("u", "Toggle Top Bar", "omarchy-shell -q bar toggle")
    submap_cmd("k", "Keybindings Menu", "omarchy-menu-keybindings")
    submap_cmd("c", "Capture Menu", "omarchy-menu toggle trigger.capture")
    submap_cmd("o", "Power Panel", "omarchy-shell shell toggle omarchy.power")
  ...
  hl.define_submap("Programming", function()
    ...
    submap_cmd("h", "GitHub Web", "omarchy-launch-webapp 'https://github.com/'")
  ...
  hl.define_submap("Office", function()
    ...
    submap_cmd("k", "Wikipedia ES", "omarchy-launch-webapp 'https://es.wikipedia.org/wiki/'")
    ...
    submap_cmd({ "c", "q" }, "Calculator", "omacalc")
    submap_cmd("i", "Emojis Picker", "omarchy-shell shell toggle omarchy.emojis")
    hl.bind("ESCAPE", reset_submap)
  end)
  ...
  -- ---------------------------------------------------------
  -- 7. ALT + M -> Media (Music & Audio Streaming)
  -- ---------------------------------------------------------
  hl.define_submap("Media", function()
    submap_cmd("s", "Spotify", "omarchy-launch-or-focus spotify")
    submap_cmd("c", "Cliamp TUI", "uwsm-app -- xdg-terminal-exec -e cliamp")
    submap_cmd({ "space", "SPACE" }, "Play / Pause", "playerctl play-pause")
    submap_cmd("l", "Next Track", "playerctl next")
    submap_cmd("h", "Previous Track", "playerctl previous")
  ...
  hl.define_submap("Frames", function()
    ...
    submap_cmd("b", "Tiled Fullscreen", "omarchy-hyprland-window-tiled-fullscreen-toggle")
