...
function M.setup_standard_submaps()
  ...
  hl.define_submap("System", function()
    ...
    submap_cmd({ "B", "SHIFT + b", "SHIFT + B" }, "Wallpaper Menu", "omarchy-menu toggle background")
    submap_cmd({ "T", "SHIFT + t", "SHIFT + T" }, "Theme Menu", "omarchy-menu toggle theme")
    submap_cmd({ "V", "SHIFT + v", "SHIFT + V" }, "Toggle Top Bar", "omarchy-shell -q bar toggle")
    submap_cmd({ "K", "SHIFT + k", "SHIFT + K" }, "Keybindings Menu", "omarchy-menu-keybindings")
    submap_cmd({ "C", "SHIFT + c", "SHIFT + C" }, "Capture Menu", "omarchy-menu toggle trigger.capture")
  ...
  hl.define_submap("Office", function()
    ...
    submap_cmd({ "E", "SHIFT + e", "SHIFT + E" }, "Emojis Picker", "omarchy-shell shell toggle omarchy.emojis")
    hl.bind("ESCAPE", reset_submap)
  end)
